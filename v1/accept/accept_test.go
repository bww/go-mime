...
func TestParseMediaType(t *testing.T) {
	...
	for _, testCase := range testCases {
		t.Run(testCase.name, func(t *testing.T) {
			...
			result, err := ParseMediaType(request)
			if err != nil {
				t.Errorf("Unexpected error \"%s\" for %s", err, testCase.header)
...
func TestParseMediaTypeErrors(t *testing.T) {
	...
	for _, testCase := range testCases {
		t.Run(testCase.name, func(t *testing.T) {
			...
			_, err = ParseMediaType(request)
			if err == nil {
				t.Errorf("Expected an error for %s", testCase.header)
			} else if !errors.Is(err, testCase.err) {
				t.Errorf("Unexpected error \"%s\", expected \"%v\" for %s", err, testCase.err, testCase.header)
			}
		})
	}
}
...
func TestMatchAcceptableMediaType(t *testing.T) {
	testCases := []struct {
		...
		}, MediaType{"application", "json", Parameters{}}, Parameters{}},
		{"Type and subtype", "application/json", []MediaType{
			{"application", "json", Parameters{}},
		}, MediaType{"application", "json", Parameters{}}, Parameters{}},
		{"Capitalized type and subtype", "Application/Json", []MediaType{
			{"application", "json", Parameters{}},
		}, MediaType{"application", "json", Parameters{}}, Parameters{}},
		{"Multiple accept types", "text/plain,application/xml", []MediaType{
			{"text", "plain", Parameters{}},
		}, MediaType{"text", "plain", Parameters{}}, Parameters{}},
		{"Multiple accept types, second available", "text/plain,application/xml", []MediaType{
			{"application", "xml", Parameters{}},
		}, MediaType{"application", "xml", Parameters{}}, Parameters{}},
		{"Accept weight", "text/plain;q=1.0", []MediaType{
			{"text", "plain", Parameters{}},
		}, MediaType{"text", "plain", Parameters{}}, Parameters{}},
		{"Wildcard", "*/*", []MediaType{
			{"application", "json", Parameters{}},
		}, MediaType{"application", "json", Parameters{}}, Parameters{}},
		{"Wildcard subtype", "application/*", []MediaType{
			{"application", "json", Parameters{}},
		}, MediaType{"application", "json", Parameters{}}, Parameters{}},
		{"Weight with dot", "a/b;q=1.", []MediaType{
			{"a", "b", Parameters{}},
		...
		{"Weight and media type parameter", "a/b;q=1;e=e", []MediaType{
			{"a", "b", Parameters{}},
		}, MediaType{"a", "b", Parameters{}}, Parameters{"e": "e"}},
		{"", "a/*,a/a;q=0", []MediaType{
			{"a", "a", Parameters{}},
			{"a", "b", Parameters{}},
		}, MediaType{"a", "b", Parameters{}}, Parameters{}},
	...
	for _, testCase := range testCases {
		t.Run(testCase.name, func(t *testing.T) {
			...
			result, extensionParameters, err := MatchAcceptableMediaType(request, testCase.availableMediaTypes)
...
func TestMatchAcceptableMediaTypeErrors(t *testing.T) {
	testCases := []struct {
		name                string
		header              string
		availableMediaTypes []MediaType
	...
	for _, testCase := range testCases {
		t.Run(testCase.name, func(t *testing.T) {
			...
			_, _, err = MatchAcceptableMediaType(request, testCase.availableMediaTypes)
			if err == nil {
				t.Errorf("Expected an error for %s", testCase.header)
			} else if !errors.Is(err, testCase.err) {
				t.Errorf("Unexpected error \"%s\", expected \"%v\" for %s", err, testCase.err, testCase.header)
